"""Fix models with question column

Revision ID: 16a5cd75957b
Revises: a7256a42affa
Create Date: 2025-09-23 01:35:13.244010
...
revision = '16a5cd75957b'
down_revision = 'a7256a42affa'
branch_labels = None
depends_on = None
